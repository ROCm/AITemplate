...
class XdlOpType(enum.Enum):
    ...
    DeviceConv2d_Xdl_CShuffle_Bias_FastGelu = auto()
...
XdlOpTag = {
    ...
    XdlOpType.DeviceConv2d_Xdl_CShuffle_Bias_FastGelu: "ck::tensor_operation::device::DeviceConv2dFwdXdl_C_Shuffle_Bias_Activation_Input_N_Hi_Wi_C_Weight_K_Y_X_C_Output_N_Ho_Wo_K",
