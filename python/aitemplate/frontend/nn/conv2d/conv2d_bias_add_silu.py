...
#
"""
General template module for conv2e + bias + residual + silu
"""
from .common_conv2d_bias_add_act import Conv2dBiasAddAct


class Conv2dBiasAddSiLU(Conv2dBiasAddAct):
    r"""Applies 2D convolution with bias + add + silu.
    ...
    Examples::
        ...
        >>> m = nn.Conv2dBiasAddSiLU(128, 256, 3, 1)
