...
#
"""
ROCM codegen functions for conv2d_bias_add_silu.
"""
import jinja2
...
@registry.reg("rocm.conv2d_bias_add_silu.config")
def conv2d_config(func_attrs):
    ...
    extra_kind = ck_lib.library.TensorOperation.AddAddSiLU
    func_attrs["op_instance"] = common.extract_config(op_kind, extra_kind)


@registry.reg("rocm.conv2d_bias_add_silu.gen_profiler")
def conv2d_gen_profiler(func_attrs, workdir, shape_template):
    ...
    return common.gen_profiler(
        ...
        conv2d_flag="bias_add_silu",
        extra_code=EXTRA_CODE.render(),
    )


@registry.reg("rocm.conv2d_bias_add_silu.gen_function")
...
@registry.reg("rocm.conv2d_bias_add_silu.func_decl")
def conv2d_gen_function_decl(func_attrs):
    ...
    return common.gen_function_decl(func_name=func_name, conv2d_flag="bias_add_silu")


@registry.reg("rocm.conv2d_bias_add_silu.func_call")
def conv2d_gen_function_call(func_attrs, indent="  "):
    ...
    """
    return common.gen_function_call(func_attrs, indent, conv2d_flag="bias_add_silu")


@registry.reg("rocm.conv2d_bias_add_silu.filter")
